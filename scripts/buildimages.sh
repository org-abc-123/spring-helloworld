...
echo 'building image demo-buildstage'
cd source/output/src
${CONTAINER_RUNTIME} build -f Dockerfile.buildstage -t demo-buildstage .
cd -

echo 'building image demo'
cd source/output/src
${CONTAINER_RUNTIME} build -f Dockerfile -t demo .
cd -
