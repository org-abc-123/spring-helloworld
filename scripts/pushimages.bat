...
echo "pushing image demo"
%CONTAINER_RUNTIME% tag demo %REGISTRY_URL%/%REGISTRY_NAMESPACE%/demo
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/demo

echo "pushing image demo-buildstage"
%CONTAINER_RUNTIME% tag demo-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/demo-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/demo-buildstage
